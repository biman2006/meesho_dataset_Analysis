...
The dataset contains order-level information with the following columns:
...
Top states by number of orders and revenue

Average order value analysis

Order status breakdown (Delivered, Shipped, Cancelled, Return, RTO)

Percentage of failed orders (Cancelled + Return + RTO)

Total revenue and total shipping cost
...
Pie chart for order outcome percentage
...
Certain states contribute significantly higher order volumes and revenue.
...
Write analytical SQL queries using GROUP BY, ORDER BY, CASE WHEN, and aggregation functions

Perform data cleaning and business-oriented analysis

Convert SQL outputs into clear visual insights
